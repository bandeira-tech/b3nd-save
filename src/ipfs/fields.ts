 ...
 *
 * IPFS blocks are opaque bytes. Custom-entity records are encoded as
 * JSON (UTF-8 bytes) — the same canonical scheme used by
 * fs/localstorage/s3 so a record round-trips cleanly across stores.
 */
